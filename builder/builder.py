...
for project in projects:
    ...
    main_readme_content += f"-- {project['desc']} \n\n"
    first_project_image = project['images'][0]
    main_readme_content += f"<img alt='{first_project_image['desc']}' src='projects/{project['name']}/assets/{first_project_image['path']}' width='250px' height='200px' />\n\n"
